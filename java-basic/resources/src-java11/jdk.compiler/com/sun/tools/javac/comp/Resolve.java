 ...
 ****************************************************************************/
    ...
    Symbol findIdent(Env<AttrContext> env, Name name, KindSelector kind) {
        return checkNonExistentType(checkVarType(findIdentInternal(env, name, kind), name));
    }
    ...
    Symbol findIdentInPackage(Env<AttrContext> env, TypeSymbol pck,
        ...
        return checkNonExistentType(checkVarType(findIdentInPackageInternal(env, pck, name, kind), name));
    }
    ...
    Symbol findIdentInType(Env<AttrContext> env, Type site,
                           Name name, KindSelector kind) {
        return checkNonExistentType(checkVarType(findIdentInTypeInternal(env, site, name, kind), name));
    }
    private Symbol checkNonExistentType(Symbol symbol) {
        ...
        if (symbol instanceof ClassSymbol) {
            ClassSymbol c = (ClassSymbol)symbol;
            return c.type.isErroneous() && c.classfile == null ? typeNotFound : symbol;
        } else return symbol;
    }
