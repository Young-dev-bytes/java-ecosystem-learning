    ...
    private class LocalAttr
        ...
        public boolean equals(Object obj) {
            if (this == obj) {
                ...
                LocalAttr localAttr = (LocalAttr) obj;
                return Objects.equals(name, localAttr.name) && Objects.equals(value, localAttr.value);
            }
        }
        ...
        if (engineIsCertificateEntry(alias)) {
            ...
            if (entry instanceof TrustedCertEntry) {
                ...
                return new KeyStore.TrustedCertificateEntry(
                        tEntry.cert, Set.of(
                                new LocalAttr("2.16.840.1.113894.746875.1.1", tEntry.trustedKeyUsageValue),
