...
class ZipFile implements ZipConstants, Closeable {
     ...
     */
    private static final boolean disableZip64ExtraFieldValidation = Boolean.valueOf(
            GetPropertyAction.privilegedGetProperty("jdk.util.zip.disableZip64ExtraFieldValidation"));
