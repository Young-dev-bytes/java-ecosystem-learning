...
public final class JavaAdapterFactory {
   ...
   /**
    ...
    private static class AdapterInfo {
        ...
        private static final int INSTANCE_ADAPTERS_MAX_CAPACITY = 64;
        ...
        private final Map<CodeSource, StaticClass> instanceAdapters = Collections.synchronizedMap(new LinkedHashMap<>() {
            @Override
            protected boolean removeEldestEntry(Map.Entry<CodeSource, StaticClass> eldest) {
                return size() > INSTANCE_ADAPTERS_MAX_CAPACITY;
            }
        });
