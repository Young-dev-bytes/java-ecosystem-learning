...
class CodeServerRouteWrapper {
    ...
    constructor() {
        ...
        this.mintKey = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            if (!this.mintKeyPromise) {
                this.mintKeyPromise = new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            const key = yield this.mintKeyPromise;
            res.end(key);
        });
